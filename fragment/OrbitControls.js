// Fork from https://github.com/jiannanya/three.js/blob/feature/addFollowZooming/examples/jsm/controls/OrbitControls.js
...
class OrbitControls extends EventDispatcher {
	...
	constructor( object, domElement ) {
		...
		function zoomToCursor(event){
			...
			v.sub(scope.object.position).setLength(scope.zoomSpeed * 100) // it needs more speed here;
