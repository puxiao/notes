...
2. 将 xxx.js 文件自动生成对应的 .d.ts 文件



假设我们本身使用的就是 TypeScript 环境，那么可以通过 jsdoc 将我们的 .ts 或 .tsx 代码文件自动生成对应的 API 文档。



假设我们没有使用 TypeScript 环境，除了可以自动生成 API 文档之外，还可以自动生成 xx.js 对应的 xx.d.ts ，方便我们发布包含 类型声明 的代码。
