...
4. 当我们说 加号键，或者说 摁数字 9 键，是指小键盘上的 加号键 和 数字键

   > 小键盘上的摁键名称格式为：Numpad + Xxx，例如数字键 2 即 Numpad2、加号键为 NumpadPlus、减号键为 NumpadMinus

5. 方向键为 上下左右，也就是 Up、Down、Left、Right

6. 其他键和他们本身的名字一样，例如 F11、Esc、Home 等

7. 鼠标左键英文简写为 LMB、鼠标右键为 RMB、鼠标中键为 MMB、鼠标滚动为 Wheel
