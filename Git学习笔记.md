...
5. 在 Github 网页操作中，找到自己提交的分支，点击 拉取请求(compare and pull request) 的按钮
6. 编写详细的拉取请求合并原因，例如自己做了哪些修改，为什么希望合并自己的该分支
7. 等待开源项目负责人审核你的代码，再由他们决定是否将你申请合并的分支，合并到开源项目中
8. 若开源项目负责人同意合并你的分支，开源项目更新过后的 master 将同步到你的 Fork master 分支中
